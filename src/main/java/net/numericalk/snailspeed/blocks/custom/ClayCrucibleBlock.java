...
import net.numericalk.snailspeed.blocks.entity.custom.ClayCrucibleBlockEntity;
import org.jetbrains.annotations.Nullable;

import java.util.stream.Stream;

public class ClayCrucibleBlock extends BlockWithEntity implements BlockEntityProvider {
    public static final EnumProperty<Direction> FACING = Properties.HORIZONTAL_FACING;
    public static final MapCodec<ClayCrucibleBlock> CODEC = ClayCrucibleBlock.createCodec(ClayCrucibleBlock::new);
    ...
    public @Nullable <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        ...
        return validateTicker(type, SnailBlockEntities.CLAY_CRUCIBLE_BLOCK_ENTITY,
