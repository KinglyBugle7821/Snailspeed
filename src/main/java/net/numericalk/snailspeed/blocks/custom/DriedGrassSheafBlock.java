...
import net.numericalk.snailspeed.blocks.entity.custom.DriedGrassSheafBlockEntity;
...
public class DriedGrassSheafBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    public DriedGrassSheafBlock(Settings settings) {
        super(settings);
    }
    ...
    public @Nullable BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new DriedGrassSheafBlockEntity(pos, state);
    }
    ...
    public @Nullable <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        ...
        return validateTicker(type, SnailBlockEntities.DRIED_GRASS_SHEAF,
    ...
    public void appendTooltip(ItemStack stack, Item.TooltipContext context, List<Text> tooltip, TooltipType type) {
        if(!Screen.hasShiftDown()) {
            ...
            tooltip.add(Text.translatable("tooltip.snailspeed.block.dried_grass_sheaf"));
            tooltip.add(Text.translatable("tooltip.snailspeed.guide.dried_grass_sheaf"));
        }
