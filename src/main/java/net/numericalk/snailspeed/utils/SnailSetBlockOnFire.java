...
public class SnailSetBlockOnFire {
    public static void SetOnFire(){
        ...
        FlammableBlockRegistry.getDefaultInstance().add(SnailBlocks.DAMAGED_OAK_PLANKS, 5, 20);
        FlammableBlockRegistry.getDefaultInstance().add(SnailBlocks.DAMAGED_SPRUCE_PLANKS, 5, 20);
        FlammableBlockRegistry.getDefaultInstance().add(SnailBlocks.DAMAGED_BIRCH_PLANKS, 5, 20);
        FlammableBlockRegistry.getDefaultInstance().add(SnailBlocks.DAMAGED_JUNGLE_PLANKS, 5, 20);
        FlammableBlockRegistry.getDefaultInstance().add(SnailBlocks.DAMAGED_ACACIA_PLANKS, 5, 20);
        FlammableBlockRegistry.getDefaultInstance().add(SnailBlocks.DAMAGED_DARK_OAK_PLANKS, 5, 20);
        FlammableBlockRegistry.getDefaultInstance().add(SnailBlocks.DAMAGED_MANGROVE_PLANKS, 5, 20);
        FlammableBlockRegistry.getDefaultInstance().add(SnailBlocks.DAMAGED_CHERRY_PLANKS, 5, 20);
        FlammableBlockRegistry.getDefaultInstance().add(SnailBlocks.DAMAGED_BAMBOO_PLANKS, 5, 20);
        FlammableBlockRegistry.getDefaultInstance().add(SnailBlocks.DAMAGED_PALE_OAK_PLANKS, 5, 20);
        ...
        FlammableBlockRegistry.getDefaultInstance().add(SnailBlocks.TAPPED_SPRUCE_LOG, 5, 20);
        FlammableBlockRegistry.getDefaultInstance().add(SnailBlocks.TAPPED_BIRCH_LOG, 5, 20);
        FlammableBlockRegistry.getDefaultInstance().add(SnailBlocks.TAPPED_PALE_OAK_LOG, 5, 20);

        FlammableBlockRegistry.getDefaultInstance().add(SnailBlocks.DECAYED_SPRUCE_LOG, 5, 20);
        FlammableBlockRegistry.getDefaultInstance().add(SnailBlocks.DECAYED_BIRCH_LOG, 5, 20);
        FlammableBlockRegistry.getDefaultInstance().add(SnailBlocks.DECAYED_PALE_OAK_LOG, 5, 20);
        ...
        FlammableBlockRegistry.getDefaultInstance().add(SnailBlocks.RESIN_BOWL, 5, 20);
    }
}
