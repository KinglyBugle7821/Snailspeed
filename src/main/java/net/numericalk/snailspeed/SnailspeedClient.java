...
public class SnailspeedClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        BlockRenderLayerMap.INSTANCE.putBlock(SnailBlocksBrain.CAMPFIRE_BASE, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(SnailBlocksBrain.FILTERING_TRAY, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(SnailBlocksBrain.CLAY_MOLD, RenderLayer.getTranslucent());
        BlockRenderLayerMap.INSTANCE.putBlock(SnailBlocksBrain.DRIED_CLAY_MOLD, RenderLayer.getTranslucent());
        BlockRenderLayerMap.INSTANCE.putBlock(SnailBlocksBrain.FIRED_CLAY_MOLD, RenderLayer.getTranslucent());
        BlockRenderLayerMap.INSTANCE.putBlock(SnailBlocksBrain.SAW_TABLE, RenderLayer.getCutout());
