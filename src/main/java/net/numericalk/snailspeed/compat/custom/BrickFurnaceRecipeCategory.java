...
public class BrickFurnaceRecipeCategory implements DisplayCategory<BasicDisplay> {
    public static final Identifier TEXTURE = Identifier.of(Snailspeed.MOD_ID,
            "textures/gui/compat/rei/brick_furnace_rei_gui.png");
    ...
    public Text getTitle() {
        return Text.translatable("block.snailspeed.brick_furnace");
    }

    @Override
    public Renderer getIcon() {
        return EntryStacks.of(SnailBlocks.BRICK_FURNACE.asItem().getDefaultStack());
    }
    ...
    public List<Widget> setupDisplay(BasicDisplay display, Rectangle bounds) {
        ...
        widgets.add(Widgets.createSlot(new Point(startPoint.x + 44, startPoint.y + 51))
                .entries(display.getInputEntries().get(0)).markInput());
        widgets.add(Widgets.createSlot(new Point(startPoint.x + 62, startPoint.y + 51))
        ...
        widgets.add(Widgets.createSlot(new Point(startPoint.x + 62, startPoint.y + 33))
                .entries(display.getInputEntries().get(3)).markInput());
        widgets.add(Widgets.createSlot(new Point(startPoint.x + 53, startPoint.y + 15))
