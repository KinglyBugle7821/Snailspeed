...
public class ClayCrucibleBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    private static final MapCodec<ClayCrucibleBlock> CODEC = ClayCrucibleBlock.createCodec(ClayCrucibleBlock::new);
    ...
    public @Nullable <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        ...
        return validateTicker(type, SnailBlockEntities.CLAY_CRUCIBLE,
